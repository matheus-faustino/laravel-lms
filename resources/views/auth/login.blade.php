    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <div class="mb-8 text-center">
                <h1 class="text-2xl font-semibold text-gray-900">{{ __('pages.login.title') }}</h1>
                <p class="mt-1 text-sm text-gray-500">{{ __('pages.login.subtitle') }}</p>
            </div>
