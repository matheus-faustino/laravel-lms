...
@section('title', __('admin/enrollments.edit_title'))
...
@section('breadcrumbs')
    <x-breadcrumb :items="[
        ...
        ['label' => __('admin/enrollments.edit_title')],
    ]" />
@endsection
...
<div class="max-w-lg">
    <div class="card p-8">
        <form method="POST" action="{{ route('admin.enrollments.update', $enrollment->id) }}" class="space-y-5">
            @csrf
            @method('PUT')
